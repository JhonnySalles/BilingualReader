...
enum class FileType(var type: Int, var extension: Array<String>, var mimeType: Array<String>, var acronym : String) {
    ...
    DOC(TYPE_BOOK, arrayOf("doc"), arrayOf("application/msword"), "DOC"),
    DOCX(TYPE_BOOK, arrayOf("docx"), arrayOf("application/vnd.openxmlformats-officedocument.wordprocessingml.document"), "DOCX"),
    ...
    ODT(TYPE_BOOK, arrayOf("odt"), arrayOf("application/vnd.oasis.opendocument.text"), "ODT"),
