...
class PopupMangaSubtitleVocabulary : Fragment() {
    ...
    override fun onCreateView(
        ...
        val root = inflater.inflate(R.layout.popup_manga_subtitle_vocabulary, container, false)
        ...
        mListPageVocabulary = root.findViewById(R.id.popup_manga_list_subtitle_page_vocabulary)
