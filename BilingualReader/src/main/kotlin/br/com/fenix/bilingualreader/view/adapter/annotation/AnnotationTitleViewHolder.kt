...
class AnnotationTitleViewHolder(itemView: View, private val listener: AnnotationsListener) : RecyclerView.ViewHolder(itemView) {
    ...
    fun bind(annotation: Annotation, isFirst: Boolean) {
        ...
        itemView.findViewById<TextView>(R.id.book_annotation_divider_count).text = itemView.context.getString(R.string.book_annotation_list_divide_count, annotation.count)
    }
