...
class PopupMangaColorFilterFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        mCustomFilter = view.findViewById(R.id.popup_manga_switch_color_filter)
        mColorRed = view.findViewById(R.id.popup_manga_seekbar_color_filter_red)
        mColorGreen = view.findViewById(R.id.popup_manga_seekbar_color_filter_green)
        mColorBlue = view.findViewById(R.id.popup_manga_seekbar_color_filter_blue)
        mColorAlpha = view.findViewById(R.id.popup_manga_seekbar_color_filter_alpha)
        mGrayScale = view.findViewById(R.id.popup_manga_switch_grayscale)
        mInvertColor = view.findViewById(R.id.popup_manga_switch_invert_color)
        mBlueLight = view.findViewById(R.id.popup_manga_switch_blue_light)
        mBlueLightAlpha = view.findViewById(R.id.popup_manga_seekbar_blue_light_alpha)
        mSepia = view.findViewById(R.id.popup_manga_switch_sepia_color)

        mFilterRed = view.findViewById(R.id.popup_manga_color_filter_red_value)
        mFilterBlue = view.findViewById(R.id.popup_manga_color_filter_blue_value)
        mFilterGreen = view.findViewById(R.id.popup_manga_color_filter_green_value)
        mFilterAlpha = view.findViewById(R.id.popup_manga_color_filter_alpha_value)
        mFilterBlueLightAlpha = view.findViewById(R.id.popup_manga_color_blue_light_value)
    ...
    override fun onCreateView(
        ...
        val root = inflater.inflate(R.layout.popup_manga_color_filter, container, false)
