...
class AboutFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        view.findViewById<Button>(R.id.about_btn_shared).setOnClickListener {
            val shareBody = "Download Bilingual Reader on Play Store: link"
            val shareSub = "Bilingual Reader : Support to reading manga with vocabulary, meaning and kanji reading features."
