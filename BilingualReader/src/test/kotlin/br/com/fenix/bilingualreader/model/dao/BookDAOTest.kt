...
class BookDAOTest : DataBaseBaseTest() {
    ...
    fun listByLibrary() {
        val dao = db.getBookDao()
        val book1 = BookMock.mockEntity(1L).apply { fkLibrary = 10L }
        val book2 = BookMock.mockEntity(2L).apply { fkLibrary = 10L }
        val book3 = BookMock.mockEntity(3L).apply { fkLibrary = 20L }
    ...
    fun listByFolder() {
        val dao = db.getBookDao()
        val book1 = BookMock.mockEntity(1L).apply { folder = "FolderA" }
        val book2 = BookMock.mockEntity(2L).apply { folder = "FolderB" }
        ...
        assertEquals("FolderA", listA[0].folder)
    }
}
