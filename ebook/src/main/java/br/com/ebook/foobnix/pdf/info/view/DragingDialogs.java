...
import br.com.ebook.foobnix.android.utils.BaseItemAdapter;
...
import br.com.ebook.foobnix.pdf.info.presentation.OutlineAdapter;
import br.com.ebook.foobnix.pdf.info.widget.ColorsDialog;
import br.com.ebook.foobnix.pdf.info.widget.FontDialog;
import br.com.ebook.foobnix.pdf.info.widget.TapZoneDialog;
...
import br.com.ebook.foobnix.pdf.search.activity.msg.FlippingStart;
import br.com.ebook.foobnix.pdf.search.activity.msg.FlippingStop;
import br.com.ebook.foobnix.pdf.search.activity.msg.InvalidateMessage;
import br.com.ebook.foobnix.pdf.search.activity.msg.MovePageAction;
import br.com.ebook.foobnix.pdf.search.menu.MenuBuilderM;
...
import br.com.ebook.foobnix.pdf.info.presentation.PageThumbnailAdapter;
import br.com.ebook.foobnix.pdf.info.widget.DialogTranslateFromTo;
import br.com.ebook.foobnix.pdf.info.wrapper.AppBookmark;
import br.com.ebook.foobnix.pdf.info.wrapper.ListBoxHelper;
            ...
            public View getContentView(final LayoutInflater inflater) {
                ...
                textDayColor.setOnClickListener(new OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        new ColorsDialog((FragmentActivity) controller.getActivity(), true, AppState.get().colorDayText, AppState.get().colorDayBg, false, isSolid, new ColorsDialog.ColorsDialogResult() {
                ...
                textNigthColor.setOnClickListener(new OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        new ColorsDialog((FragmentActivity) controller.getActivity(), false, AppState.get().colorNigthText, AppState.get().colorNigthBg, false, isSolid, new ColorsDialog.ColorsDialogResult() {
                    ...
                    public void onClick(View v) {
                        ...
                        for (String line : AppState.get().readColors.split(";")) {
                            ...
                            child.setOnClickListener(new OnClickListener() {
                                ...
                                @Override
                                public void onClick(View v) {
                                    new ColorsDialog((FragmentActivity) controller.getActivity(), (Boolean) t1Img.getTag(), (Integer) t3Text.getTag(), (Integer) t2BG.getTag(), true, true, new ColorsDialog.ColorsDialogResult() {
