...
//    }
    ...
    @Override
    public void getOutline(ResultResponse<List<OutlineLinkWrapper>> outline, boolean forse) {
        if (codeDocument == null) {
            return;
        }
    ...
    @Override
    public void doSearch(final String text, final ResultResponse<Integer> result) {
